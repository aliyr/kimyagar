...
export const PROPS = {
  /**
   * کوبه: فریم‌های pestle_{1..3} بوم مشترک دارند (چرخش پخته‌شده)؛ سرِ کوبه داخل
   * دهانه و دسته رو به بالا-راست. نسبت‌ها از چیدمان اندازه‌گیری‌شده‌ی قبلی
   * (Zone 320×300: {346,488,204,230}) — با تغییر اندازه‌ی هاون خودکار می‌ماند.
   */
  pestle: mortarRel(0.26875, -0.3733, 0.6375, 0.7667),
  /** ماده‌ی داخل هاون — کل دهانه‌ی کاسه را پر می‌کند (Zone قدیمی: {308,634,224,88}) */
  mortarContents: mortarRel(0.15, 0.1133, 0.7, 0.2933),
